...
AddEventHandler('nix_o2mask:trajebuceo', function()
	...
	ESX.Game.SpawnObject('p_s_scuba_mask_s', {
		...
		ESX.Game.SpawnObject('p_s_scuba_tank_s', {
			...
			Citizen.Wait(70000)
			ESX.ShowNotification('Nivel ~b~oxigeno~y~ en el tanque:', '~y~', '50' .. '%.')

			Citizen.Wait(45000)
			ESX.ShowNotification('Nivel ~b~oxigeno~y~ en el tanque:', '~y~', '25' .. '%.')

			Citizen.Wait(45000)
			ESX.ShowNotification('Nivel ~b~oxigeno~y~ en el tanque:', '~y~', '0' .. '%.')
